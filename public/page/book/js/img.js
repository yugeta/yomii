...
export class Img{
  ...
  get dimension(){
    return this.get_dimension(this.id, this.w, this.h)
  }
  get single(){
    return this.get_single_flg(this.id, this.w, this.h)
  }
  ...
  get_single_flg(id,w,h){
    if(Data.file_info.singles.indexOf(id) === -1){
      return true
    }
    else{
